...
parameters = dict(maxCorners = 100, qualityLevel = 0.3, minDistance = 7)

parameters_lucas_kanade = dict(winSize = (15,15), maxLevel = 2, criteria = (cv2.TermCriteria_EPS | cv2.TERM_CRITERIA_COUNT, 10, 0.03))
...
edges = cv2.goodFeaturesToTrack(frame_gray_init, mask=None, **parameters)
